...
public class FileHelper2 {
    ...
    private static FileHelper.Configuration configuration;
    private static boolean hasConfig;

//    public static FileHelper.Configuration configuration(Context context) {
//        return configuration == null ? getConfiguration(context) : configuration;
//    }
//
//    private static FileHelper.Configuration getConfiguration(Context context) {
//        return new FileHelper.Configuration(context);
//    }
//
...
//        }
//
//        public FileHelper.Configuration folderPath(String folderPath) {
//            FileHelper.folderPath = folderPath;
//            return this;
//        }
//
//        public FileHelper.Configuration imageFileName(String imageFileName) {
//            FileHelper.imageFileName = imageFileName;
//            FileHelper.autoImageFileName = true;
//            return this;
//        }
//
//        public FileHelper.Configuration setAutoImageFileName(boolean autoImageFileName) {
//            FileHelper.autoImageFileName = autoImageFileName;
//            return this;
//        }
//
//        public FileHelper.Configuration writeToExternalStorrage(boolean writeToExternalStorrage) {
//            FileHelper.writeToExternalStorrage = writeToExternalStorrage;
//            return this;
//        }
//
//
//        public FileHelper.Configuration environment(String environment) {
//            FileHelper.environment = environment;
//            return this;
//        }
//
//        public FileHelper.Configuration createTempFile(boolean createTempFile) {
//            FileHelper.createTempFile = createTempFile;
//            return this;
//        }
//
//        public FileHelper.Configuration suffix(String suffix) {
